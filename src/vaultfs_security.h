#ifndef VAULTFS_SECURITY_H
#define VAULTFS_SECURITY_H
...
struct vaultfs_security_info {
	...
	unsigned char password_hash[VAULTFS_PASSWORD_SIZE];	//hash of the filesystem password
